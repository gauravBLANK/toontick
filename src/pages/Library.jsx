...
const Library = () => {
  ...
  const statusCounts = {
    ...
    plan_to_read: library.filter((item) => item.status === "plan_to_read")
      .length,
  ...
  if (error) {
    const isTableError =
      error.includes("Failed to fetch library") ||
      error.includes('relation "user_library" does not exist');
          ...
          {isTableError && (
            ...
            >
              ...
              <ol style={{ color: "var(--text-secondary)", lineHeight: "1.6" }}>
                ...
                <li>
                  Copy the contents of <code>supabase_migration.sql</code> from
                  your project
                </li>
          ...
          >
            ...
            {error.includes("duplicate key") && (
              <button
                onClick={() => {
                  console.log(
                    "🧹 Clearing localStorage to fix duplicate key error..."
                  );
            ...
            {isTableError && (
              <button
                onClick={() => {
                  ...
                  console.log(
                    "Make sure you have run the Supabase migration SQL"
                  );
                }}
                className="btn btn-secondary"
                style={{
    ...
    <>
      ...
      <div className="container">
          ...
          <div style={{ marginBottom: "2rem" }}>
            ...
            >
              {[
                ...
                { key: "plan_to_read", label: "Planned", color: "#9013FE" },
        ...
        {!loading && library.length === 0 ? (
          ...
          >
            <p>
              Your library is empty. Start adding manhwa from the search page!
            </p>
          </div>
